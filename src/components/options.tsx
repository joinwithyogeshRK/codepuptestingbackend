...
const ProjectTypeSelector: React.FC<ProjectTypeSelectorProps> = ({
  ...
  const [selectedType, setSelectedType] = useState<'frontend' | 'fullstack' | null>(null);
  ...
  const projectTypes = [
    {
      ...
      description: 'Perfect for portfolios, landing pages, blogs, and informational websites',
      icon: Palette,
      features: [
    ...
    },
    {
      ...
      description: 'Complete solution for websites that need user accounts and data storage',
      icon: Layers,
      features: [
          ...
          return (
            <motion.div
              ...
              className={`project-type-card-container ${
                isOtherSelected ? 'project-type-card-container-selected' : 'project-type-card-container-unselected'
              }`}
            >
              <motion.button
                ...
                } ${type.id === "fullstack" ? "project-type-card-disabled" : ""}`} // custom class for coming soon
              ...
              >
                ...
                <div className="project-type-card-shimmer-container">
                  <div className="project-type-card-shimmer" style={{
                ...
                <div className="project-type-card-content">
                  <div className="project-type-card-header">
                    ...
                    {!isLoading && (
                      <ArrowRight className={`project-type-card-arrow group-hover:opacity-100 group-hover:translate-x-1 ${
                        type.id === 'frontend' 
                  ...
                  <h3 className={`project-type-card-title ${
                    type.id === 'frontend' 
                  ...
                  <div className="project-type-card-features-container">
                    <h4 className={`project-type-card-features-title ${
                      type.id === 'frontend' 
                    ...
                    <ul className="project-type-card-features-list">
                      {type.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className={`project-type-card-feature-item ${
                          type.id === 'frontend' 
                            ? 'project-type-card-feature-item-frontend' 
                            : 'project-type-card-feature-item-fullstack-disabled'
                        }`}>
                          <div className={`project-type-card-feature-dot ${
                            type.id === 'frontend' 
