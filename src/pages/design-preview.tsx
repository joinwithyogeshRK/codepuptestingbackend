  ...
  return (
    ...
    >
      ...
      <div className="color-swatch-content">
        <p className="color-swatch-name">
          {name}
        </p>
        <p className="color-swatch-hex">
          {color}
        </p>
    ...
    <div className={`${getDeviceClasses()} device-preview-container`}>
      ...
      <div className="device-preview-content" style={{ backgroundColor }}>
        ...
        <div className="device-preview-hero">
          ...
          />
          <div className="device-preview-hero-text" style={{ width: '90%' }} />
          <div className="device-preview-hero-text" style={{ width: '60%' }} />
        </div>
        ...
        <div className="device-preview-cards">
          <div className="device-preview-card">
            ...
            <div className="device-preview-card-text" style={{ width: '60%' }} />
          </div>
          <div className="device-preview-card">
            <div 
              className="device-preview-card-image"
            ...
            />
            <div className="device-preview-card-text" />
            <div className="device-preview-card-text" style={{ width: '80%' }} />
          </div>
        </div>
          ...
          <div className="device-preview-features">
            {(designChoices.differentSections || designChoices.features || []).slice(0, 2).map((feature, index) => (
              <div key={index} className="device-preview-feature">
                ...
                />
                <span className="device-preview-feature-text" style={{ color: textColor }}>
          ...
          >
            ...
            <div className="design-preview-modal-header">
              <div className="design-preview-modal-header-left">
                ...
                <div>
                  <h2 className="design-preview-modal-title">{designChoices.projectName || projectName || "Design Preview"}</h2>
                  <p className="design-preview-modal-subtitle">Design Preview & Color Palette</p>
                </div>
              </div>
                  ...
                  {designStats.map((stat, index) => (
                    ...
                    >
                      <div className="design-preview-stat-content">
                        ...
                        <div>
                          <p className="design-preview-stat-value">{stat.value}</p>
                          <p className="design-preview-stat-label">{stat.label}</p>
                        </div>
                      </div>
                    </motion.div>
                  ))}
                ...
                <div className="design-preview-main-grid">
                  ...
                  <div>
                    ...
                    {colorPairs.length > 0 ? (
                      ...
                      <p className="design-preview-no-colors">No colors defined</p>
                    )}
                    
                    {/* Color explanation */}
                    {designChoices.colorExplanation && (
                      <div className="design-preview-color-explanation">
                        <p className="design-preview-color-explanation-label">Color Strategy</p>
                        <p className="design-preview-color-explanation-text">{designChoices.colorExplanation}</p>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="design-preview-details-container">
                      {(designChoices.businessName || designChoices.businessType) && (
                        <div className="design-preview-detail-item">
                          <p className="design-preview-detail-label">Business</p>
                          <p className="design-preview-detail-value">{designChoices.businessName || designChoices.businessType}</p>
                        </div>
                      )}
                      ...
                      {designChoices.vibe && (
                        <div className="design-preview-detail-item">
                          ...
                          <p className="design-preview-detail-value">{designChoices.vibe}</p>
                        </div>
                      )}
                      
                      {(designChoices.style || designChoices.recommendedLayout) && (
                        <div className="design-preview-detail-item">
                          <p className="design-preview-detail-label">Layout Style</p>
                          <p className="design-preview-detail-value">{designChoices.recommendedLayout || designChoices.style}</p>
                        </div>
                      )}

                      {designChoices.recommendedLayoutExplanation && (
                        <div className="design-preview-detail-item">
                          <p className="design-preview-detail-label">Layout Explanation</p>
                          <p className="design-preview-detail-text">{designChoices.recommendedLayoutExplanation}</p>
                        </div>
                      )}
                      ...
                      {(designChoices.layout) && (
                        <div className="design-preview-detail-item">
                          ...
                          <p className="design-preview-detail-value">{designChoices.layout}</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="design-preview-layout-grid">
                      {designChoices.differentLayouts.map((layout, index) => (
                        ...
                        >
                          <span className="design-preview-layout-text">{layout}</span>
                          {layout === designChoices.recommendedLayout && (
                            <div className="design-preview-layout-recommended-label">
                              <span className="design-preview-layout-recommended-text">Recommended</span>
                            </div>
                          )}
                        </motion.div>
                      ))}
                    ...
                    <div className="design-preview-features-grid">
                      {(designChoices.differentSections || designChoices.features || []).map((item, index) => (
                        ...
                        >
                          ...
                          />
                          <span className="design-preview-feature-text-small">{item}</span>
                        </motion.div>
                      ))}
                    </div>
                  </div>
                    ...
                    <div className="design-preview-device-selector">
                      {deviceButtons.map(({ key, icon: Icon, label }) => (
                        ...
                        >
                          ...
                          <span className="design-preview-device-button-text">{label}</span>
                        </button>
                      ))}
                    </div>
                  </div>
