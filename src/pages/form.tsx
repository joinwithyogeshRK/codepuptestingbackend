        ...
        <div className="supabase-modal-header">
          <div className="supabase-modal-header-content">
            ...
            <div>
              ...
              <p className="supabase-modal-subtitle">Configure your backend connection</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="supabase-modal-close-button"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="supabase-form-container">
          ...
          <div className="supabase-auto-setup-section">
            <div className="supabase-auto-setup-header">
              ...
              <div>
                <h3 className="supabase-auto-setup-title">Auto-Setup Backend</h3>
                ...
                <div className="supabase-input-container">
                  <input
                    ...
                    className={`supabase-form-input supabase-form-input-with-icon ${
                      errors.accessToken ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                    }`}
                  />
                  <button
                    type="button"
          ...
          {showProjectLimit && (
            <div className="supabase-project-limit-section">
              <div className="supabase-project-limit-header">
                ...
                <div>
                  <h3 className="supabase-project-limit-title">Project Limit Reached</h3>
                    ...
                    {limitProjects.map((project) => (
                      <div key={project.id} className="supabase-project-item">
                        <div className="supabase-project-info">
                          <p className="supabase-project-name">{project.name}</p>
                          <p className="supabase-project-detail">ID: {project.id}</p>
                          <p className="supabase-project-detail">Status: {project.status}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`supabase-form-input ${
                      errors.projectId ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                    }`}
                  />
                  {errors.projectId && (
          ...
          <div className="supabase-manual-config-section">
            <div className="supabase-manual-config-divider">
              <h3 className="supabase-manual-config-title">Manual Configuration</h3>
              ...
              <div>
                ...
                <input
                  ...
                  className={`supabase-form-input ${
                    errors.supabaseUrl ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                  }`}
                />
                {errors.supabaseUrl && (
              ...
              <div>
                ...
                <div className="supabase-input-container">
                  <input
                    ...
                    className={`supabase-form-input supabase-form-input-with-icon ${
                      errors.supabaseAnonKey ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                    }`}
                  />
                  <button
                    type="button"
                ...
                {errors.supabaseAnonKey && (
                  <p className="supabase-error-message">{errors.supabaseAnonKey}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="supabase-input-container">
                  <input
                    ...
                    placeholder="eyJhbGciOiJIUzI1NiIs..."
                    className={`supabase-form-input supabase-form-input-with-icon ${
                      errors.supabaseToken ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                    }`}
                  />
                  <button
                    type="button"
                ...
                {errors.supabaseToken && (
                  <p className="supabase-error-message">{errors.supabaseToken}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="supabase-input-container">
                  <input
                    ...
                    className={`supabase-form-input supabase-form-input-with-icon ${
                      errors.databaseUrl ? 'supabase-form-input-error' : 'supabase-form-input-normal'
                    }`}
                  />
                  <button
                    type="button"
          ...
          <div className="supabase-help-section">
            <div className="supabase-help-content">
              ...
              <div className="supabase-help-text">
                <p className="supabase-help-title">Where to find these values:</p>
          ...
          <div className="supabase-actions-container">
            ...
            <div className="supabase-actions-group">
              ...
              <button
                type="submit"
                className="supabase-save-button"
              >
